  ...
  /* Test API_Response object. */
    ...
    "Search_URL_tests:": {
      ...
      "Search_url_A:": function (done) {
        this.api.search_url('http://www.tineye.com/images/meloncat.jpg', null, null, null, null, done(function (data) {
    ...
    "Search_Data_tests:": {
      ...
      "Search_data_A:": function (done) {
        ...
        this.api.search_data(img, 10, null, null, null, done(function (data) {
            assert.equals(data['results']['matches'].length, 10)
            assert.equals(data['code'], 200)
        }))
      }
    ...
    "Remaining_Searches_tests:": {
      ...
      "Remaining_Searches:": function (done) {
        this.api.remaining_searches(done(function (data) {
            assert.equals(data['code'], 200)
    ...
    "Image_Count_tests:": {
      ...
      "Image_Count:": function (done) {
        this.api.image_count(done(function (data) {
            assert.equals(data['code'], 200)
        }))
      }  
    }
